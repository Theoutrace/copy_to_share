...
document.addEventListener('DOMContentLoaded', function(){
    ...
    arrayOfKeys.forEach(function(key){
        ...
        //for this we will use JSON.parse
        const unstringifiedValuesAgainstKeys = JSON.parse(valuesAgainstKeysInLocal)
        // console.log(unstringifiedValuesAgainstKeys);

        //step 22 (c)
        //get the name and email values out of the object so formed by step 22 (b)
        const nameValue = unstringifiedValuesAgainstKeys.name
        const emailValue = unstringifiedValuesAgainstKeys.email
        // console.log(nameValue,emailValue);              //working

        // step 22 (d)
        // place those values in h4 and and create buttons of edit and delete
        const creatingH4ForName = document.createElement('h4')
        // console.log(creatingH4ForName);
        const creatingH4ForEmail = document.createElement('h4')
        // console.log(creatingH4ForEmail);
        ...
        //assigning class to the h4 with the email 
        ...
        //assignig classes to buttons same as it was given for non reloded cases  
        ...
        // step 22 (e)
        //create an inner div and append all the items in it
        const innerDivForRelodedData = document.createElement('div')

        //assign calss to the div created
        innerDivForRelodedData.classList.add('single-item')

        //appending all to their parents
        //selecting parent div with id 'div-containing-items'
        ...
        // step 22 (f)
        // asign the funcationality to edit and delete buttons 
        ...
        deleteButtonForRelodedData.addEventListener('click', function(){
            ...
            // console.log('targetElementEmailThroughEditBtnInRelodedData',targetElementEmailThroughEditBtnInRelodedData);       //will give us edit button
            const targetKeyEmailElementForRelodedData = targetElementEmailThroughEditBtnInRelodedData.previousSibling
            // console.log(targetKeyEmailElementForRelodedData);
